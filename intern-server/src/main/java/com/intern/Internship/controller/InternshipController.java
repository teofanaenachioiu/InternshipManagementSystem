...
public class InternshipController {
    ...
    public PageDTO<InternshipDTO> findJsonDataByPageAndSize(
        ...
        if (!(orderBy.equals(OrderBy.ADDEDDATE.getOrderByCode())
                || orderBy.equals(OrderBy.AVGFEEDBACK.getOrderByCode())
    ...
    PageDTO<InternshipDTO> pageInternship =internshipService.getInternships(page,size,areasOfInterest,orderBy, direction);
