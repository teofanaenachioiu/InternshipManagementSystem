...
class CandidateRepositoryTest {
    ...
    public void test() {
        ...
        Candidate fromRepository = candidateRepository.getOne(candidate.getID());
        assert (fromRepository.getLastName().equals("Popescu"));
        assert (fromRepository.getStudies().size() == 2);
        assert (fromRepository.getExperiences().size() == 2);
    }
}