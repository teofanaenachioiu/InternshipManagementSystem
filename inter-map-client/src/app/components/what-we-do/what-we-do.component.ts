...
export class WhatWeDoComponent implements OnInit {
  ...
  ngOnInit() {
    this.items = [
      {title: 'About Intermap', icon: 'assets/img/interMAP.png', icontext: 'assets/img/intremapRight.jpg',
      ...
      {title: 'For students', icon: 'assets/img/ForStud.png', icontext: 'assets/img/right-side-image_2.jpg',
      ...
      {title: 'For companies', icon: 'assets/img/forComp.jpg', icontext: 'assets/img/right-side-image_3.jpg',
        tag: '#for-companies', text: 'As a company, you are the key element of student development. All you have to do is come and meet' +
          ...
          'application.'},
      {title: 'About CV', icon: 'assets/img/cv.jpg', icontext: 'assets/img/right-side-image_4.jpg',
      ...
      {title: 'Photos', icon: 'assets/img/fivth-list-icon.png', icontext: 'assets/img/right-side-image_5.jpg',
        tag: '#photos', text: ''},
    ];
  }
